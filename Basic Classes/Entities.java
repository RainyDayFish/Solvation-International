...
public abstract class Entities
{
   ...
   *
   * @parameter newX An int representing the new x position of an Entity on the screen.
   */
   ...
   *
   * @parameter newY An int representing the new y position of an Entity on the screen.
   */
   ...
   *
   * @parameter newImage A BufferedImage representing the Entity visually onto the screen.
   */
   ...
   *
   * @parameter x An int value which is assigned to the instance variable x.
   * @parameter y An int value which is assigned to the instance variable y.
   */
   ...
   *
   * @parameter x An int value which is assigned to the instance variable x, setting an x location of the object.
   * @parameter y An int value which is assigned to the instance variable y, settting a y location of the object.
   * @parameter image A BufferedImage which is assigned to the instance variable image, setting a visual representation for the object.
   */
